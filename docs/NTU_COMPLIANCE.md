...
| 紙本順序：外封面、書名頁、審定書、選擇性謝辭、中英文摘要、目次、圖次、表次、正文、文獻、附錄、封底 | 電子與紙本以 print 選項切換；正文四章；表次後另附符號與縮寫頁 | 印刷廠外封面、書脊、封底與裝訂 |
...
四章主體及符號與縮寫頁是使用者選定的寫作架構，不是圖書館規定的章節數或必備頁面。架構調整不改變封面、目次／圖次／表次名稱、連續頁碼或其他定稿檢查；參考論文中的空白頁與英文目次標題不覆蓋本模板的格式設定。
